...
namespace REPOBlacklist
{
    ...
    ///
    /// Deliberately not patched: GetKey / GetKeyDown / GetKeyUp — so the F3 toggle
    /// (and any other plugin hotkeys) keep working while the menu is open.
    /// </summary>
    public static class InputBlocker
    {
        ...
        // These are bound dynamically because we don't reference the InputSystem
        // assembly at compile time. Called once from Plugin.Awake after PatchAll.
